...
// Side Nav for small screens
	function openNav() {
		...
		document.querySelector(".hamburger-menu").style.display = "none"; // Hide hamburger icon
	}

	function closeNav() {
		document.getElementById("mySidenav").style.width = "0";
		document.querySelector(".hamburger-menu").style.display = "block"; // Show hamburger icon
	}
